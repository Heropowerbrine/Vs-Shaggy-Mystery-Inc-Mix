...
class TitleState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(['Original Mod by'], -60);
				...
				// credTextShit.screenCenter();
				case 9:
					createCoolText(["we didnt have time"]);
				// credTextShit.visible = true;
				case 11:
					addMoreText("to finish the sprites");
				// credTextShit.text += '\nlmao';
				case 12:
					deleteCoolText();
					addMoreText('Happy');
