			...
			switch (curWeek)
			{
				...
				default:
					...
					if (true)
					{
						...
						PlayState.storyDifficulty = PlayState.originallyPickedDiff = curDifficulty;

						if (curDifficulty == 0 && !WeekData.songHasMania[songArray[0]]) {
							PlayState.storyDifficulty = 1;
							diffic = CoolUtil.difficultyStuff[PlayState.storyDifficulty][1];
						}
