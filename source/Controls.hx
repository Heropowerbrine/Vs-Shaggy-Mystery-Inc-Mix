...
class Controls extends FlxActionSet
{
	...
	public function setHitBox(hitbox:FlxHitbox, ?type:Int) {
		...
		switch(type){					
		case 5:
			inline forEachBound(Control.A1, (action, state) -> addbutton(action, hitbox.array[0], state));
			inline forEachBound(Control.A2, (action, state) -> addbutton(action, hitbox.array[1], state));
			inline forEachBound(Control.A3, (action, state) -> addbutton(action, hitbox.array[2], state));
			inline forEachBound(Control.A4, (action, state) -> addbutton(action, hitbox.array[3], state));
			inline forEachBound(Control.A5, (action, state) -> addbutton(action, hitbox.array[4], state));
			inline forEachBound(Control.A6, (action, state) -> addbutton(action, hitbox.array[5], state));									
		case 6:	
			inline forEachBound(Control.A1, (action, state) -> addbutton(action, hitbox.array[0], state));
			inline forEachBound(Control.A2, (action, state) -> addbutton(action, hitbox.array[1], state));
			inline forEachBound(Control.A3, (action, state) -> addbutton(action, hitbox.array[2], state));
			...
			inline forEachBound(Control.A5, (action, state) -> addbutton(action, hitbox.array[4], state));
			inline forEachBound(Control.A6, (action, state) -> addbutton(action, hitbox.array[5], state));
			inline forEachBound(Control.A7, (action, state) -> addbutton(action, hitbox.array[6], state));					
		case 8:
			inline forEachBound(Control.B1, (action, state) -> addbutton(action, hitbox.array[0], state));
			inline forEachBound(Control.B2, (action, state) -> addbutton(action, hitbox.array[1], state));
			inline forEachBound(Control.B3, (action, state) -> addbutton(action, hitbox.array[2], state));
			inline forEachBound(Control.B4, (action, state) -> addbutton(action, hitbox.array[3], state));
			inline forEachBound(Control.B5, (action, state) -> addbutton(action, hitbox.array[4], state));
			inline forEachBound(Control.B6, (action, state) -> addbutton(action, hitbox.array[5], state));
			inline forEachBound(Control.B7, (action, state) -> addbutton(action, hitbox.array[6], state));
			inline forEachBound(Control.B8, (action, state) -> addbutton(action, hitbox.array[7], state));
			inline forEachBound(Control.B9, (action, state) -> addbutton(action, hitbox.array[8], state));											
		case 3:	
			inline forEachBound(Control.NOTE_UP, (action, state) -> addbutton(action, hitbox.array[2], state));
			inline forEachBound(Control.NOTE_DOWN, (action, state) -> addbutton(action, hitbox.array[1], state));
			inline forEachBound(Control.NOTE_LEFT, (action, state) -> addbutton(action, hitbox.array[0], state));
			inline forEachBound(Control.NOTE_RIGHT, (action, state) -> addbutton(action, hitbox.array[3], state));	
		}
	}
